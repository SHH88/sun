...
- [4. 路由](#4-路由)
  - [4.1. 【对路由的理解】](#41-对路由的理解)
  - [4.2. 【基本切换效果】](#42-基本切换效果)
  - [4.3. 【两个注意点】](#43-两个注意点)
  - [4.4. 【路由器工作模式】](#44-路由器工作模式)
  - [4.5. 【to的两种写法】](#45-to的两种写法)
  - [4.6. 【命名路由】](#46-命名路由)
  - [4.7. 【嵌套路由】](#47-嵌套路由)
  - [4.8. 【路由传参】](#48-路由传参)
  - [4.9. 【路由的props配置】](#49-路由的props配置)
  - [4.10. 【replace属性】](#410--replace属性)
  - [4.11. 【编程式导航】](#411-编程式导航)
  - [4.12. 【重定向】](#412-重定向)
- [5. pinia](#5-pinia)
  - [5.1. 【准备一个效果】](#51-准备一个效果)
  - [5.2. 【搭建 pinia 环境】](#52-搭建-pinia-环境)
  - [5.3. 【存储+读取数据】](#53-存储读取数据)
  - [5.4. 【修改数据】(三种方式)](#54-修改数据三种方式)
  - [5.5. 【storeToRefs】](#55-storetorefs)
  - [5.6. 【getters】](#56-getters)
  - [5.7. 【$subscribe】](#57-subscribe)
  - [5.8. 【store组合式写法】](#58-store组合式写法)
- [6. 组件通信](#6-组件通信)
  - [6.1. 【props】](#61-props)
  - [6.2. 【自定义事件】](#62-自定义事件)
  - [6.3. 【mitt】](#63-mitt)
  - [6.4. 【v-model】](#64-v-model)
  - [6.5. 【$attrs】](#65-attrs)
  - [6.6. 【$refs、$parent】](#66-refsparent)
  - [6.7. 【provide、inject】](#67-provideinject)
  - [6.8. 【pinia】](#68-pinia)
  - [6.9. 【slot】](#69-slot)
- [7. 其它 API](#7-其它-api)
  - [7.1. 【shallowRef 与 shallowReactive】](#71-shallowref-与-shallowreactive)
  - [7.2. 【readonly 与 shallowReadonly】](#72-readonly-与-shallowreadonly)
  - [7.3. 【toRaw 与 markRaw】](#73-toraw-与-markraw)
  - [7.4. 【customRef】](#74-customref)
- [8. Vue3新组件](#8-vue3新组件)
  - [8.1. 【Teleport】](#81-teleport)
  - [8.2. 【Suspense】](#82-suspense)
  - [8.3. 【全局API转移到应用对象】](#83-全局api转移到应用对象)
  - [8.4. 【其他】](#84-其他)
# 1. Vue3简介
